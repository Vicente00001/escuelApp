...
// Define el tipo de las claves del objeto grades
type Subject = 'Matematicas' | 'Lenguaje' | 'Inglés' | 'Biología' | 'Química' | 'Física' | 'Educación';

const grades: Record<Subject, string> = {
        ...
        {Object.keys(grades).map((subject) => (
          <Card key={subject} style={styles.gradeCard}>
            <Card.Content>
              ...
              <Text style={styles.grade}>Calificación: {grades[subject as Subject]}</Text>
